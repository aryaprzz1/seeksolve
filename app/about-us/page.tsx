        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4">
              ...
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl animate-fadeIn">Seek&Solve: Our Story</h1>
              <p className="text-muted-foreground md:text-xl">
                Founded in 1998, Ace Elite Detective Service has grown to become one of the most trusted investigative
                firms in India, with a reputation for excellence, integrity, and results.
              </p>
            </div>
            <div className="relative lg:ml-auto">
              <Image
                ...
                width={500}
                height={500}
                alt="Ace Elite Detective Service Headquarters"
            ...
            {[
              {
                ...
                title: "Foundation",
                description:
                  "Ace Elite Detective Service was founded by former police officer Rajesh Verma with a small team of three investigators.",
              },
              {
                year: "2005",
                title: "Expansion",
            ...
            {[
              {
                ...
                bio: "Former police officer with 30+ years of investigative experience. Specializes in complex fraud cases and high-profile investigations.",
