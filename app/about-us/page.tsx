        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4">
              ...
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">Elite Detective Agency: Our Story</h1>
              <p className="text-muted-foreground md:text-xl">
                Founded in 1998, Elite Detective Agency has grown to become one of the most trusted investigative firms
                in the country, with a reputation for excellence, integrity, and results.
              </p>
            </div>
            <div className="relative lg:ml-auto">
              <Image
                ...
                width={500}
                height={500}
                alt="Elite Detective Agency Headquarters"
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">25 Years of Investigative Excellence</h2>
            ...
            {[
              {
                ...
                title: "Foundation",
                description:
                  "Elite Detective Agency was founded by former FBI agent Michael Reynolds with a small team of three investigators.",
              },
              {
                year: "2005",
                title: "Expansion",
              ...
              },
              {
                ...
                description:
                  "Received the National Association of Investigative Specialists Award for Excellence in Private Investigation.",
              },
              {
                year: "2020",
                title: "Global Reach",
                description:
                  "Established a network of international partners, allowing us to conduct investigations worldwide.",
              },
              {
                year: "Today",
                title: "Industry Leader",
                description:
                  "Now with offices in 5 major cities and a team of over 50 specialized investigators, we continue to set the standard for investigative excellence.",
              },
            ].map((milestone, index) => (
            ...
            {[
              {
                ...
                bio: "Former FBI agent with 30+ years of investigative experience. Specializes in complex fraud cases and high-profile investigations.",
              ...
              <div
                key={index}
                className="flex flex-col items-center space-y-4 border rounded-lg p-6 hover:shadow-md transition-shadow"
              >
                <Image
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="grid gap-10 lg:grid-cols-2 items-center">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground md:text-xl">
                Elite Detective Agency maintains all required state and federal licenses, and our investigators hold
                numerous professional certifications in their specialized fields.
              </p>
