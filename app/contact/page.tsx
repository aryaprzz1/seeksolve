        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="relative lg:ml-auto">
              <Image
                src="https://unsplash.com/photos/silhouette-photo-of-a-man-with-hat-standing-near-concrete-building-at-daytime-lbekri_riMg"
                width={500}
                height={500}
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">aceelitedetectiveservices@gmail.com</p>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
                  ...
                  <Button size="lg" className="w-full" asChild>
                    <Link href="mailto:aceelitedetectiveservices@gmail.com">aceelitedetectiveservices@gmail.com</Link>
                  </Button>
                </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              ...
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10" asChild>
                <Link href="mailto:aceelitedetectiveservices@gmail.com">Email Us</Link>
              </Button>
            </div>
          </div>
        </div>
