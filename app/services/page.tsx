        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4">
              ...
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">Professional Detective Services</h1>
              <p className="text-muted-foreground md:text-xl">
                Ace Elite Detective Service offers a comprehensive range of investigative services for individuals,
                businesses, and legal professionals. Each service is delivered with the highest standards of
                professionalism, discretion, and ethical conduct.
              </p>
            </div>
