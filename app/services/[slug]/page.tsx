...
const services = [
  {
    ...
    caseStudy: {
      title: "Reuniting a Family After 15 Years",
      description:
        "A client approached us to locate their sibling who had lost contact with the family 15 years prior. Through a combination of social media analysis, public records searches, and field investigation, we were able to locate the individual in another state. After confirming their identity and current situation, we facilitated a reunion between the family members.",
    },
  ...
  },
  {
    ...
    caseStudy: {
      ...
      description:
        "An attorney client needed to recover potentially case-changing evidence from a water-damaged mobile phone. Our digital forensics team was able to extract and restore the data, revealing text messages and photos that proved crucial to establishing the timeline in a civil litigation case, ultimately leading to a favorable settlement for our client.",
    },
    image: "/placeholder.svg?height=400&width=600",
  ...
  },
  {
    ...
    caseStudy: {
      ...
      description:
        "An insurance company client suspected a claimant of exaggerating injuries from a workplace accident. Our surveillance team documented the subject engaging in physical activities that directly contradicted their claimed limitations. The video evidence we provided allowed our client to successfully challenge the fraudulent claim, saving them over $200,000 in potential payouts.",
    },
    image: "/placeholder.svg?height=400&width=600",
    slug: "surveillance",
  },
          ...
          <div className="grid gap-10 lg:grid-cols-3">
            ...
            <div className="space-y-6">
              <div className="border rounded-lg p-6">
                <h3 className="text-xl font-bold mb-4">Why Choose Elite Detective Agency</h3>
