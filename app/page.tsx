...
import AgencyImage from "@/components/agency-image"
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="relative lg:ml-auto flex justify-center">
              <AnimatedLogo width={300} height={300} className="animate-fadeIn" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-10 lg:grid-cols-2 items-center">
            ...
            <div className="relative lg:ml-auto flex justify-center">
              <AgencyImage
                width={300}
                height={300}
                alt="Seek&Solve Detective Logo"
                className="mx-auto animate-slideUp"
              />
            </div>
          </div>
        </div>
